                ...
                <?php
                  ...
                  while ($alumno = $resultado->fetch_assoc()) {
                    echo "<tr>
                      ...
                      <td>{$alumno['apellido_alumno']}
                      </td>
                      <td>{$alumno['doc_alumno']}</td>
                      <td>
                      <a href='materias.php?id_alumno={$alumno['id_alumno']}'>
                  ...
                  <tr>
                    <td>
                      <a href="cargar_alumnos.php">
                        <button type="button" name="button" class="btn btn-primary" >Cargar Alumno</button>
                      </a>
                    </td>
                  </tr>
                  <?php
