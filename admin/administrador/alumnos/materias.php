...
$sql = "SELECT materias.*, alumno_materia_notas.nota FROM materias
LEFT JOIN alumno_materia_notas ON alumno_materia_notas.id_materia = materias.id_materia AND alumno_materia_notas.id_alumno = {$idAlumno} ";
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Listado de materias de <?php $oAlumno = $alumno->fetch_assoc(); echo $oAlumno['nombre_alumno']; ?>
      </h1>
    </section>
              ...
              <table id="example2" class="table table-bordered table-hover">
                ...
                <?php
                  ...
                  while ($materia = $resultado->fetch_assoc()) {
                    $botonNota = !is_null($materia['nota']) ? $materia['nota'] : "<a href='cargar_nota.php?id_materia={$materia['id_materia']}&id_alumno={$idAlumno}'><button class='btn btn-primary'>Cargar nota</button></a> ";
                    echo "<tr>
