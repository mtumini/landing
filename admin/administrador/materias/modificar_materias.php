...
$materiaNombre = $_GET['id_materia'];

$sql = "SELECT * FROM materias where id_materia = {$materiaNombre}";
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            <!-- /.box-header -->
            <div class="box-body">
              <form action="modificar_materias_save.php" method="post">
                <?php
                $materia = $resultado->fetch_assoc();
                echo "<input type='text' placeholder='{$materia["nombre_materia"]}' name='nombreMateria' min='1' max='10'/>";
                echo "<input type='hidden' value='{$materia["id_materia"]}' name='idMateria' min='1' max='10'/>";
                ?>
